...
const App = () => {
  const [rotateClass, setRotateClass] = useState(null);
      ...
      >
        <div className="landing-child">
          ...
          >
            ...
            <ul
              className={`planet-ul rotating-70 ${rotateClass}`}
              onMouseEnter={() => setRotateClass('paused')}
              onMouseLeave={() => setRotateClass(null)}
            >
              <animated.li
                className={`planet planet1 pulse ${pulse1}`}
              ...
              ></animated.li>
              <animated.li
                className={`planet planet2 pulse ${pulse2}`}
              ...
              ></animated.li>
              <animated.li
                className={`planet planet3 pulse ${pulse3}`}
              ...
              ></animated.li>
              <animated.li
                className={`planet planet4 pulse ${pulse4}`}
